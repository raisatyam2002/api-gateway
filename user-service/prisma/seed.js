...
function seedUser() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const hashedPassword = yield (0, bcryptjs_1.hash)("123456", 10);
            for (const u of users) {
                try {
                    yield index_1.default.user.upsert({
                        where: {
                            id: u.id,
                        },
                        create: {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            for (const address of addresses) {
                try {
                    yield index_1.default.address.upsert({
                        where: {
                    ...
                    console.log("❌ Error while creating an address for user ", address.userId, error);
                }
            }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            for (const product of products) {
                try {
                    yield index_1.default.product.upsert({
                        where: {
                            id: product.id,
                        },
                        create: {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            for (const order of orders) {
                try {
                    yield index_1.default.order.upsert({
                        where: {
                            id: order.id,
                        },
                        create: {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            for (const orderItem of orderItems) {
                try {
                    yield index_1.default.orderItem.upsert({
                        where: {
                            id: orderItem.id,
                        },
                        create: {
                    ...
                    console.log("❌ Error while creating an order item ", orderItem.id, error);
                }
            }
